            ...
            <tr>
               ...
               <td colspan="8">
                    ...
                    <div>
                        ...
                        <input type="submit" class="btn btn-info btn-lg" style="background-color:rgb(237,250,252);color:rgb(22,97,109)" value="添加商品">
                        <input type="submit" class="btn btn-info btn-lg" style="background-color:rgb(237,250,252);color:rgb(22,97,109);margin-left: 30px" value="批量删除">
